    ...
    return (
        <>
                        ...
                        <ul className="navbar-nav" style={{ marginRight: '100px' }}>
                            <li className="nav-item">
                                <button style={{ backgroundColor: 'black', borderRadius: '12px', width: '120px' }}>
                                    <Link style={{textDecoration:'none'}} to="/feedback"><a style={{ color: '#34c94b' }} className="nav-link" href="">Feedback</a></Link>
                                </button>
                            </li>
                        </ul>
                    </div>
            ...
            {search && bar.filter(data=>data.title.toLowerCase().includes(search)).map((data)=>{
              return(
                <div onClick={()=>navigate(`/nextpage`,{state:{data}})} style={{cursor:'pointer',display:"flex",justifyContent:"space-between",backgroundColor:"#34c94b",color:'black',alignItems:'center',padding:'10px'}}>
                    ...
                    {api.slice(0,8).map((data,index)=>{
                      return (
                        <>
                         ...
                         <Card onClick={()=>navigate('/nextpage',{state:{data}})} style={{backgroundColor:'#34c94b'}} >

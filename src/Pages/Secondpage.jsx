...
// useEffect(()=>{
//     fetch('https://qtify-backend-labs.crio.do/songs').then(response=>response.json()).then(result=>setSongs(result))
...
//                     </b> <br />
//                     <button className='btn-5'><i class="fa-solid fa-shuffle"></i> &nbsp; Shuffle</button> &nbsp;&nbsp;
//                     <button className='btn-5'> <i class="fa-brands fa-spotify"></i> &nbsp; Add to Library</button>
...
//       <th style={{ border: '2px solid black', padding: '10px',backgroundColor:'#34c94b' }}>Artist</th>
...
//     {songs.map((res, index) => {
//       return (
//         <tr className='tddata' key={index}>
//           <td  style={{ border: '2px solid black', padding: '10px' }}> <img style={{width:'59px',height:'64px'}} src={res.image} alt="" /> {res.title}</td>
//           <td style={{ border: '2px solid black', padding: '10px' }}>{res.artists[0]}{res.artists[1]}</td>
//           <td  style={{ border: '2px solid black', padding: '10px' }}>{formatDuration(res.durationInMs)}</td>
//         </tr>
//       );
//     })}
//   </tbody>
